...
function markDown(data) {
  ...
  let markdown = "# " + data.title + "\n"
   ...
   // add questions
   markdown += "## " + sections[6] + "\n";
   markdown += "You can find more of my work [HERE](https://github.com/" + data.github + ") on Github\n";
   markdown += "You can email me at " + data.email + " with any additional questions.\n"
  return `# ${data.title}
